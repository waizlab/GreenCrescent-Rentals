...
<nav class="navbar">
    <a href="/GreenCrescent_Rentals/frontend/customer/dashboard.php" class="<?php echo $__current === 'dashboard.php' ? 'active' : ''; ?>">
    ...
    <a href="/GreenCrescent_Rentals/frontend/customer/cars/browse_cars.php" class="<?php echo $__current === 'browse_cars.php' ? 'active' : ''; ?>">
    ...
    <a href="/GreenCrescent_Rentals/frontend/customer/bookings/my_bookings.php" class="<?php echo $__current === 'my_bookings.php' ? 'active' : ''; ?>">
