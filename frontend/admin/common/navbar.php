...
?>
<nav class="navbar">
    <a href="/frontend/admin/dashboard.php" class="<?php echo $__current === 'dashboard.php' ? 'active' : ''; ?>">
    ...
    <a href="/frontend/admin/cars/list_cars.php" class="<?php echo $__inCars ? 'active' : ''; ?>">
    ...
    <a href="/frontend/admin/bookings/manage_bookings.php" class="<?php echo $__inBookings ? 'active' : ''; ?>">
    ...
    <a href="/frontend/admin/fares/manage_fares.php" class="<?php echo $__inFares ? 'active' : ''; ?>">
